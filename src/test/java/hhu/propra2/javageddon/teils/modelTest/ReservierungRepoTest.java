...
public class ReservierungRepoTest {
    ...
    Artikel fahrrad = Artikel.builder().titel("fahrrad").aktiv(true).standort(ad1).eigentuemer(hans).beschreibung("?").kaution(1).kostenTag(1).build();
    Artikel hamster =  Artikel.builder().titel("gwendolin").aktiv(false).standort(ad1).eigentuemer(hans).beschreibung("?").kaution(1).kostenTag(1).build();
    Artikel kochtopf =  Artikel.builder().titel("kochtopf").standort(ad1).aktiv(true).eigentuemer(heidi).beschreibung("?").kaution(1).kostenTag(1).build();
